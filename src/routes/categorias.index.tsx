  ...
  return (
    <PublicLayout>
      <div className="px-5 pt-2 md:px-0">
        ...
        <h1 className="mt-3 font-display text-2xl font-bold md:text-3xl">Categorias</h1>
          ...
          {active.map((c) => {
            ...
            return (
              <Link
                ...
                to="/categorias/$id"
                params={{ id: c.id }}
                className="group flex flex-col gap-3 rounded-3xl border border-border bg-card p-4 shadow-soft transition active:scale-[0.97] hover:-translate-y-0.5 md:p-5"
              >
                ...
                <div>
                  <h3 className="font-display text-sm font-bold leading-tight md:text-base">{c.name}</h3>
