    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary/10 via-info/5 to-accent/10 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-xl">
          ...
          <form className="mt-6 space-y-4" onSubmit={(e) => { e.preventDefault(); navigate({ to: "/admin/dashboard" }); }}>
            ...
            <button className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-primary font-semibold text-primary-foreground hover:opacity-90">
